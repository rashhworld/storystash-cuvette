...
const { loginUser, registerUser, fetchUser, fetchUserStory, fetchUserBookmark, saveUserAction, fetchUserAction } = require('../controllers/User');
...
router.get('/user/bookmark', verifyToken, fetchUserBookmark);
